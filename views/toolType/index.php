...
<div ng-controller="ToolTypeIndexController">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h4 class="panel-title pull-left" style="padding-top: 7.5px;">Tool Types</h4>
...
<script>
	...
	app.controller("ToolTypeIndexController", ['$scope', "$controller", function($scope, $controller) {
		...
		$scope.gridModel.columnDefs = [
			...
			{field: 'type_name', displayName: 'Name'},
			{field: 'delete', enableFiltering: false, width: 67, cellTemplate: '<button class="btn btn-danger" ng-click="grid.appScope.deleteById(row.entity.id,row.entity.type_name, grid.appScope.reloadGrid);">Delete</button>'
			}
		];
